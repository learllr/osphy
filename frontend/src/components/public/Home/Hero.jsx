      ...
      <div className="absolute inset-x-0 top-0 -z-10 flex size-full items-center justify-center opacity-100">
        ...
        <div className="mx-auto flex max-w-5xl flex-col items-center">
          <div className="flex flex-col items-center gap-6 text-center">
            <div>
              <h1 className="mb-12 text-pretty text-2xl font-bold lg:text-5xl">
                Simplifiez la gestion de votre cabinet d’ostéopathie
              </h1>
              <p className="text-muted-foreground lg:text-lg">
                Notre solution vous aide à gérer efficacement vos patients, organiser votre agenda et améliorer votre suivi médical.
              </p>
            </div>
